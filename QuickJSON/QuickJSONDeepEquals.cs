...
namespace QuickJSON
{
    ...
    {
        /// <summary> Perform an equality test for all values in the JToken 
        ...
        /// </summary>
        /// <param name="other">JToken to compare with</param>
        ...
        /// <summary> Static interface to Deep Equals </summary>
